...
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND ENAM"))).click()
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND LIMA"))).click()
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND EMPAT"))).click()
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND TIGA"))).click()
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND DUA"))).click()
time.sleep(3)
wait_variable.until(E.element_to_be_clickable((By.PARTIAL_LINK_TEXT, "BRAND SATU"))).click()
time.sleep(3)
